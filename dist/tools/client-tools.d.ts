...
export declare function handleListClients(registry: BrokerRegistry, brokerName: string, vpn: string, limit: number, offset: number): Promise<string>;
...
export declare function handleListClientSubscriptions(registry: BrokerRegistry, brokerName: string, vpn: string, clientName: string, limit: number, offset: number): Promise<string>;
export declare function handleListClientConnections(registry: BrokerRegistry, brokerName: string, vpn: string, username: string, limit: number, offset: number): Promise<string>;
